...
## [0.1.5](https://github.com/mpecan/cargo-lint-extra/compare/cargo-lint-extra-v0.1.4...cargo-lint-extra-v0.1.5) (2026-04-12)
...
* add collect-then-iterate AST rule ([#11](https://github.com/mpecan/cargo-lint-extra/issues/11)) ([cf6f8bb](https://github.com/mpecan/cargo-lint-extra/commit/cf6f8bbbb177740b0970c89748c175763bbc69b4))
* add collect-then-iterate AST rule ([#11](https://github.com/mpecan/cargo-lint-extra/issues/11)) ([#28](https://github.com/mpecan/cargo-lint-extra/issues/28)) ([7ce9851](https://github.com/mpecan/cargo-lint-extra/commit/7ce9851246bb24d3e7d017e6abeb838b460e8657))
...
* add string-alloc-in-loop AST rule ([#14](https://github.com/mpecan/cargo-lint-extra/issues/14)) ([8e75d71](https://github.com/mpecan/cargo-lint-extra/commit/8e75d713553c596a4dd3d7f4fe02828a7f540e66))
* add string-alloc-in-loop AST rule ([#14](https://github.com/mpecan/cargo-lint-extra/issues/14)) ([#30](https://github.com/mpecan/cargo-lint-extra/issues/30)) ([1c5b60b](https://github.com/mpecan/cargo-lint-extra/commit/1c5b60b5a9032b13631944044a80b12fdce9e125))
...
* add verbose-result-handling AST rule ([#12](https://github.com/mpecan/cargo-lint-extra/issues/12)) ([0977aed](https://github.com/mpecan/cargo-lint-extra/commit/0977aed3c28b865758a4685aaae7400c0dfd7ea9))
* add verbose-result-handling AST rule ([#12](https://github.com/mpecan/cargo-lint-extra/issues/12)) ([#32](https://github.com/mpecan/cargo-lint-extra/issues/32)) ([a1b8312](https://github.com/mpecan/cargo-lint-extra/commit/a1b8312fd0aaa4be237f5ee52c1631c877d62760))


### Bug Fixes

* -W should not force exit 1 when no diagnostics ([#27](https://github.com/mpecan/cargo-lint-extra/issues/27)) ([7648eda](https://github.com/mpecan/cargo-lint-extra/commit/7648eda31ced141d3f6eae152ed7b0e20f554e92))
* -W should not force exit 1 when no diagnostics ([#27](https://github.com/mpecan/cargo-lint-extra/issues/27)) ([#29](https://github.com/mpecan/cargo-lint-extra/issues/29)) ([772900c](https://github.com/mpecan/cargo-lint-extra/commit/772900c4b1db34df845e49d5d448d9f536c7e311))
